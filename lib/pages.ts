...
export const PAGES: Record<string, { title: string; paragraphs: string[] }> = {
  about: {
    ...
    paragraphs: [
      ...
      "There is a letter once a quarter, when the filings are in, covering what these investors bought and sold. Every issue is readable on the site whether or not you subscribe.",
