...
export const PAGES: Record<string, { title: string; paragraphs: string[] }> = {
  about: {
    ...
    paragraphs: [
      "GigaInvestors shows what 83 of the world's most followed investors own, and how that changes every quarter. Each investor's portfolio is drawn as a treemap: rectangles sized by dollar value, coloured green where they bought and red where they sold, scrubbable back through every quarter since 2006. Every stock has a page showing which of these investors hold it, how much, and since when.",
